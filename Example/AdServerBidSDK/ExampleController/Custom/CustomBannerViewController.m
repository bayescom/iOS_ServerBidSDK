...
#import "AdServerBidSDK.h"

@interface CustomBannerViewController () <AdServerBidBaseAdspotDelegate, GDTUnifiedBannerViewDelegate, BUNativeExpressBannerViewDelegate, MercuryBannerAdViewDelegate>
...
- (void)loadAdBtn1Action {
    ...
    _adspot = [[AdServerBidBaseAdspot alloc] initWithAdspotId:self.adspotId];
