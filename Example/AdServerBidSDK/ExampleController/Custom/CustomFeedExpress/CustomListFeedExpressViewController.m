...
@interface CustomListFeedExpressViewController () <UITableViewDelegate, UITableViewDataSource, AdServerBidBaseAdspotDelegate, MercuryNativeExpressAdDelegete, GDTNativeExpressAdDelegete, BUNativeExpressAdViewDelegate>
@property (strong, nonatomic) UITableView *tableView;

@property (nonatomic, strong) AdServerBidBaseAdspot *adspot;
...
- (void)loadBtnAction:(id)sender {
    ...
    _adspot = [[AdServerBidNativeExpress alloc] initWithAdspotId:self.adspotId viewController:self adSize:CGSizeMake(self.view.bounds.size.width, 300)];
...
// MARK: ======================= AdServerBidBaseAdspotDelegate =======================
/// 加载渠道广告，将会返回渠道所需参数
/// @param sdkId 渠道Id
/// @param params 渠道参数
- (void)adServerBidBaseAdspotWithSdkId:(NSString *)sdkId params:(NSDictionary *)params {
    // 根据渠道id自定义初始化
...
- (void)mercury_nativeExpressAdSuccessToLoad:(id)nativeExpressAd views:(nonnull NSArray<MercuryNativeExpressAdView *> *)views {
    if (views == nil || views.count == 0) {
        [self.adspot reportWithType:AdServerBidAdvSupplierRepoFaileded];
        ...
        [self.adspot reportWithType:AdServerBidAdvSupplierRepoSucceeded];
...
- (void)mercury_nativeExpressAdViewExposure:(MercuryNativeExpressAdView *)nativeExpressAdView {
    [self.adspot reportWithType:AdServerBidAdvSupplierRepoImped];
    NSLog(@"原生模板广告曝光回调");
}

/// 原生模板广告点击回调
- (void)mercury_nativeExpressAdViewClicked:(MercuryNativeExpressAdView *)nativeExpressAdView {
    [self.adspot reportWithType:AdServerBidAdvSupplierRepoClicked];
    NSLog(@"原生模板广告点击回调");
}
...
- (void)nativeExpressAdSuccessToLoad:(GDTNativeExpressAd *)nativeExpressAd views:(NSArray<__kindof GDTNativeExpressAdView *> *)views {
    if (views == nil || views.count == 0) {
        ...
        [_adspot reportWithType:AdServerBidAdvSupplierRepoSucceeded];
...
- (void)nativeExpressAdViewClicked:(GDTNativeExpressAdView *)nativeExpressAdView {
    [_adspot reportWithType:AdServerBidAdvSupplierRepoClicked];
}

- (void)nativeExpressAdViewExposure:(GDTNativeExpressAdView *)nativeExpressAdView {
    [_adspot reportWithType:AdServerBidAdvSupplierRepoImped];
}
...
- (void)nativeExpressAdViewRenderFail:(BUNativeExpressAdView *)nativeExpressAdView error:(NSError *)error {
    [_adspot reportWithType:AdServerBidAdvSupplierRepoFaileded];
    _csj_ad = nil;
    [_adspot selectAdvSupplierWithError:error];
}
