...
- (NSMutableArray *)loadedtkUrlWithArr:(NSArray<NSString *> *)uploadArr {
    NSMutableArray *temp = [NSMutableArray arrayWithCapacity:uploadArr.count];
    for (id obj in uploadArr.mutableCopy) {
        NSString *loadedtk = [self joinTimeUrlWithObj:obj type:AdServerBidSdkSupplierRepoLoaded];
...
- (NSMutableArray *)imptkUrlWithArr:(NSArray<NSString *> *)uploadArr price:(NSInteger)price {
    NSMutableArray *temp = [NSMutableArray arrayWithCapacity:uploadArr.count];
    for (id obj in uploadArr.mutableCopy) {
        NSString *loadedtk = [self joinTimeUrlWithObj:obj type:AdServerBidSdkSupplierRepoImped];
...
/// 拼接时间戳
/// @param urlString url
/// @param repoType AdServerBidSdkSupplierRepoType
- (NSString *)joinTimeUrlWithObj:(NSString *)urlString type:(AdServerBidSdkSupplierRepoType)repoType {
...
- (void)reportEventWithParams:(NSDictionary *)params {
    NSURL *url = [NSURL URLWithString:AdServerBidSdkEventUrl];
